                            ...
                            <div class="input-group">
                                ...
                                >
                                    ...
                                    @foreach($villes as $ville)
                                        <option value="{{ $ville->cpVilles }}" {{ old('cpLieuNaissance') == $ville->cpVilles ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                >
                                    ...
                                    @foreach($villes as $ville)
                                        <option value="{{ $ville->cpVilles }}" {{ old('cpadresse') == $ville->cpVilles ? 'selected' : '' }}>
                                            {{ $ville->designationVilles }} ({{ $ville->cpVilles }})
                                        </option>
                                    @endforeach
                                </select>
